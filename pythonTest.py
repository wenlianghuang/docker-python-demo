...
if __name__ == "__main__":
    ...
    #ch = logging.FileHandler("./test/logs/Test_Logs_{}_{}_{}_{}_{}_{}.log".format(time_date, time_date, time_date_time[0], time_date_time[1], time_date_time[2], time_date_millisecond))
